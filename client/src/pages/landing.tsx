...
const LandingPage: React.FC = () => {
  useEffect(() => {
    document.title =
      "AI-Powered Live Chat Support for Your Company - Boost Engagement & Sales | Supportly";
  }, []);
  return (
    ...
    //         Supportly helps you provide exceptional customer service with
    //         real-time chat, automated responses, and powerful analytics.
    //       </p>
    ...
    //   <section
    //     id="testimonials"
    //     className="w-full py-20 px-6 md:px-10 bg-purple-50"
    //   >
    ...
    //                 "Supportly has transformed how we handle customer support.
    //                 The response times have improved by 60% and customer
    ...
    //               </div>
    //               <p className="text-gray-600 mb-6">
    //                 "The analytics dashboard alone is worth the price. We've
    //                 been able to reduce our support costs while maintaining
    ...
    //               </div>
    //               <p className="text-gray-600 mb-6">
    //                 "Implementation was seamless and the customer support team
    //                 has been phenomenal. Our customers love the chat widget's
    //                 clean design and quick responses."
    //               </p>
    //               <div className="flex items-center gap-4">
    //                 <div className="w-10 h-10 rounded-full bg-purple-600 flex items-center justify-center text-white">
    //                   AK
    ...
    //           Join thousands of businesses that use Supportly to provide
    ...
    //             Supportly helps businesses provide exceptional customer service
    //             with real-time chat, automated responses, and powerful
    //             analytics.
    //           </p>
