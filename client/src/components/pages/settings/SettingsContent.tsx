      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row items-start mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500">Recommended dimensions: 200x200px. Maximum file size: 5MB.</p>
          </div>
        </div>
...
const Availability = () => (
  <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
    <div className="px-6 py-4 border-b border-gray-200">
      ...
      <p className="text-sm text-gray-500">Configure your working hours and availability status</p>
    </div>
    <div className="p-6">
      <p className="text-gray-500">Availability settings content goes here</p>
    </div>
  </div>
);
  ...
  <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6 border border-red-200">
    ...
    <div className="p-6">
      <div className="bg-red-50 p-4 rounded-md mb-4">
        ...
        <p className="text-sm text-red-600">The following actions are irreversible. Please proceed with caution.</p>
      </div>
      <div className="space-y-4">
        <div className="border border-gray-200 rounded-md p-4">
          <h4 className="font-semibold mb-2">Delete Workspace</h4>
          <p className="text-sm text-gray-500 mb-4">This will permanently delete your workspace and all associated data.</p>
